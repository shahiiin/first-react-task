...
const MenuBar = () => {
  return (
    <>
      <a className='link-bar' href='https://www.w3schools.com/html/default.asp'>HTML</a>
      <a className='link-bar' href='https://www.w3schools.com/js/default.asp'>Javascript</a>
